...
bool co_lrio__msg__optimization_response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("co_lrio.msg._optimization_response.OptimizationResponse", full_classname_dest, 55) == 0);
  }
  co_lrio__msg__OptimizationResponse * ros_message = _ros_message;
  {  // header
  ...
  {  // update_keyposes
    PyObject * field = PyObject_GetAttrString(_pymsg, "update_keyposes");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->update_keyposes = (Py_True == field);
    Py_DECREF(field);
  }
  {  // keyposes
    PyObject * field = PyObject_GetAttrString(_pymsg, "keyposes");
    if (!field) {
      return false;
    }
    if (!sensor_msgs__msg__point_cloud2__convert_from_py(field, &ros_message->keyposes)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of OptimizationResponse */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("co_lrio.msg._optimization_response");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OptimizationResponse");
  ...
  {  // update_keyposes
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->update_keyposes ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "update_keyposes", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // keyposes
    PyObject * field = NULL;
    field = sensor_msgs__msg__point_cloud2__convert_to_py(&ros_message->keyposes);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "keyposes", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
