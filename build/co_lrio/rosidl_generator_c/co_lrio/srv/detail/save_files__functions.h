...
#ifndef CO_LRIO__SRV__DETAIL__SAVE_FILES__FUNCTIONS_H_
#define CO_LRIO__SRV__DETAIL__SAVE_FILES__FUNCTIONS_H_
...
/// Initialize srv/SaveFiles message.
/**
...
/// Finalize srv/SaveFiles message.
/**
...
/// Create srv/SaveFiles message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * co_lrio__srv__SaveFiles_Request__init().
...
/// Destroy srv/SaveFiles message.
/**
 * It calls
 * co_lrio__srv__SaveFiles_Request__fini()
...
/// Check for srv/SaveFiles message equality.
/**
...
/// Initialize array of srv/SaveFiles messages.
/**
...
/// Finalize array of srv/SaveFiles messages.
/**
 * It calls
 * co_lrio__srv__SaveFiles_Request__fini()
...
/// Create array of srv/SaveFiles messages.
/**
 * It allocates the memory for the array and calls
 * co_lrio__srv__SaveFiles_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SaveFiles messages.
/**
 * It calls
 * co_lrio__srv__SaveFiles_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SaveFiles message array equality.
/**
...
/// Copy an array of srv/SaveFiles messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * co_lrio__srv__SaveFiles_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_co_lrio
...
/**
 * It calls
 * co_lrio__srv__SaveFiles_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_co_lrio
...
/**
 * It allocates the memory for the array and calls
 * co_lrio__srv__SaveFiles_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_co_lrio
...
/**
 * It calls
 * co_lrio__srv__SaveFiles_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CO_LRIO__SRV__DETAIL__SAVE_FILES__FUNCTIONS_H_
