...
static const _SaveFiles_Request_type_support_symbol_names_t _SaveFiles_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, co_lrio, srv, SaveFiles_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, co_lrio, srv, SaveFiles_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, co_lrio, srv, SaveFiles_Request)() {
  return &::co_lrio::srv::rosidl_typesupport_c::SaveFiles_Request_message_type_support_handle;
}
...
static const _SaveFiles_Response_type_support_symbol_names_t _SaveFiles_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, co_lrio, srv, SaveFiles_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, co_lrio, srv, SaveFiles_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_co_lrio
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, co_lrio, srv, SaveFiles_Response)() {
  return &::co_lrio::srv::rosidl_typesupport_c::SaveFiles_Response_message_type_support_handle;
}
...
static const _SaveFiles_type_support_symbol_names_t _SaveFiles_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, co_lrio, srv, SaveFiles)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, co_lrio, srv, SaveFiles)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, co_lrio, srv, SaveFiles)() {
  return &::co_lrio::srv::rosidl_typesupport_c::SaveFiles_service_type_support_handle;
}
